for i = 1:1
    ...
    time = 4*t_factor/t_factor; % Time of simulation depending on t_factor.
    ...
    SSRI_dose_factor = i;                       % mg/kg of body weight. 
    SSRI_start_time = 1*t_factor/t_factor;           % Starting time of SSRI dose in same units as t_factor.
    SSRI_dose = (SSRI_dose_factor*1e6)*(weight/1000) * 0.001; % In ug. 
    SSRI_repeat_time = 100000*t_factor/t_factor; %Time for repeat of dose. 
